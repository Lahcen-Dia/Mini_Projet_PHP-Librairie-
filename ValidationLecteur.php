...
<p>vous avez maintenant la possibilité <a href="biblio.php">réserver des livres</a> ou vous <a href="Login.php"> identifier ici</a></p>
</center>
</body>
</html>
<?php   
    ...
    $passe = $_POST['mdp'];
     ...
     if ( $nom && $prenom && $adresse && $ville && $codepostal && $passe){
       $selec=$bdd->prepare("INSERT INTO lecteurs(nom,prenom,adresse,ville,codepostale,motdepasse) VALUES('$nom','$prenom','$adresse','$ville','$codepostal','$passe')");
        $selec->execute();
   }else{
